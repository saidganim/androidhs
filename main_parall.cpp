...
const char *hammeringShaderSource = "#version 300 es\n"
	...
	"		\n"
	"		for(int id = 0; id <81; ++id){FragColor += texelFetch(evict1, ivec2(id * 4096 % 256, int(id * 4096 / 1024) * 4), 0);\n"
	"		FragColor += texelFetch(evict1, ivec2(id * 4096 % 256 + 32 , int(id * 4096 / 1024) * 4), 0);}\n"
	"	}\n"
	"}\n\0";
